        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DayOfBirths = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Id_PositionId = table.Column<int>(type: "int", nullable: true),
                    Id_DepartmentId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.Id_DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Positions_Id_PositionId",
                        column: x => x.Id_PositionId,
